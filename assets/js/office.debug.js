...
OSF.HostSpecificFileVersionMap = {
  ...
  outlook: { android: "16.00", ios: "16.00", mac: "16.00", web: "16.01", win32: "16.02" },
  powerpoint: { ios: "16.00", mac: "16.00", web: "16.00", win32: "16.01", winrt: "16.00" },
  project: { win32: "16.00" },
  sway: { web: "16.00" },
  word: { ios: "16.00", mac: "16.00", web: "16.00", win32: "16.01", winrt: "16.00" },
...
OSF.SupportedRTLLocales = { "ar-sa": true, "he-il": true, "fa-ir": true, "ur-pk": true };
...
OSF.isRTLLocale = function (a) {
  if (!a) return false;
  return OSF.SupportedRTLLocales[a.toLowerCase()] || false;
};
var ScriptLoading;
(function (e) {
  var a = false,
    ...
    c = (function () {
      ...
      function f(d) {
        var b = this;
        if (d === void 0) d = { OfficeJS: "office.js", OfficeDebugJS: "office.debug.js" };
        b.constantNames = d;
        b.defaultScriptLoadingTimeout = 1e4;
        b.loadedScriptByIds = {};
        b.scriptTelemetryBuffer = [];
        b.osfControlAppCorrelationId = "";
        b.basePath = c;
        b.getUseAssociatedActionsOnly = a;
        b.trustedTypesOptIn = a;
      }
      f.prototype.isScriptLoading = function (a) {
        return !!(this.loadedScriptByIds[a] && this.loadedScriptByIds[a].hasStarted);
      };
      f.prototype.getOfficeJsBasePathFromScript = function (h) {
        var f = [this.constantNames.OfficeJS, this.constantNames.OfficeDebugJS],
          b = h.src;
        if (!b) return "";
        for (var g = b.toLowerCase(), d = "", e = 0; !d && e < f.length; e++) {
          var c = f[e],
            a = g.indexOf(c);
          if (
            a >= 0 &&
            a === b.length - c.length &&
            (a === 0 || b.charAt(a - 1) === "/" || b.charAt(a - 1) === "\\")
          )
            d = b.substring(0, a);
          else if (
            a >= 0 &&
      ...
      f.prototype.getOfficeJsScriptElement = function () {
        if (document.currentScript) {
          var e = document.currentScript,
            a = this.getOfficeJsBasePathFromScript(e);
          if (a) return { script: e, basePath: a };
        }
        for (var d = document.getElementsByTagName("script"), b = 0; b < d.length; b++) {
          var a = this.getOfficeJsBasePathFromScript(d[b]);
          if (a) return { script: d[b], basePath: a };
        }
        return c;
      };
      f.prototype.getOfficeJsBasePath = function () {
        var a = this;
        if (!a.basePath) {
          var b = a.getOfficeJsScriptElement();
          if (!b) return "";
          var c = b.script,
            f = b.basePath;
          a.basePath = f;
          try {
            var d = c.getAttribute("data-use-associated-actions-only");
            a.getUseAssociatedActionsOnly = d === "1";
            var e = c.getAttribute("data-enable-trusted-types");
            a.trustedTypesOptIn = e === "1";
          } catch (g) {}
        }
        return a.basePath;
      };
      f.prototype.getUseAssociatedActionsOnlyDefined = function () {
        this.getOfficeJsBasePath();
        return this.getUseAssociatedActionsOnly;
      };
      f.prototype.getTrustedTypesOptIn = function () {
        this.getOfficeJsBasePath();
        return this.trustedTypesOptIn;
      };
      f.prototype.loadScript = function (e, d, c, a, b) {
        this.loadScriptInternal(e, d, c, a, b);
      };
      f.prototype.loadScriptParallel = function (e, d, b) {
        this.loadScriptInternal(e, d, c, a, b);
      };
      f.prototype.waitForFunction = function (g, d, h, i) {
        var b = h,
          f,
          c = function () {
            b--;
      ...
      f.prototype.invokeCallbackIfScriptsReady = function (h, j) {
        for (var g = a, f = 0; f < h.length; f++) {
          ...
          else if (d.hasError) g = e;
        }
        j(!g);
        return e;
      };
      f.prototype.getScriptEntryByUrl = function (d) {
        for (var b in this.loadedScriptByIds) {
          var a = this.loadedScriptByIds[b];
          if (this.loadedScriptByIds.hasOwnProperty(b) && a.url === d) return a;
        }
        return c;
      };
      f.prototype.loadScriptInternal = function (h, g, i, n, k) {
        ...
        if (h) {
          ...
          if (!d || d.hasError || d.url.toLowerCase() != h.toLowerCase()) {
            ...
            f.src = OSF.TrustedTypesPolicy ? OSF.TrustedTypesPolicy.createScriptURL(h) : h;
            r.getElementsByTagName("head")[0].appendChild(f);
          } else if (d.isReady) i(e);
        ...
        if (OSF.AppTelemetry && OSF.AppTelemetry.onScriptDone) {
          for (var c = 0; c < b.scriptTelemetryBuffer.length; c++) {
            ...
            if (OSF.AppTelemetry.onScriptDone.length == 3)
              OSF.AppTelemetry.onScriptDone(a.scriptId, a.startTime, a.msResponseTime);
            else
...
(function (b) {
  function a(c, a) {
    var b = [];
    a.id !== undefined && b.push(oteljs.makeStringDataField(c + ".Id", a.id));
    a.version !== undefined && b.push(oteljs.makeStringDataField(c + ".Version", a.version));
    a.instanceId !== undefined &&
      b.push(oteljs.makeStringDataField(c + ".InstanceId", a.instanceId));
    a.name !== undefined && b.push(oteljs.makeStringDataField(c + ".Name", a.name));
    a.marketplaceType !== undefined &&
      b.push(oteljs.makeStringDataField(c + ".MarketplaceType", a.marketplaceType));
    a.sessionId !== undefined && b.push(oteljs.makeStringDataField(c + ".SessionId", a.sessionId));
    a.browserToken !== undefined &&
      b.push(oteljs.makeStringDataField(c + ".BrowserToken", a.browserToken));
    a.osfRuntimeVersion !== undefined &&
      b.push(oteljs.makeStringDataField(c + ".OsfRuntimeVersion", a.osfRuntimeVersion));
    a.officeJsVersion !== undefined &&
      b.push(oteljs.makeStringDataField(c + ".OfficeJsVersion", a.officeJsVersion));
    a.hostJsVersion !== undefined &&
      b.push(oteljs.makeStringDataField(c + ".HostJsVersion", a.hostJsVersion));
    a.assetId !== undefined && b.push(oteljs.makeStringDataField(c + ".AssetId", a.assetId));
    a.providerName !== undefined &&
      b.push(oteljs.makeStringDataField(c + ".ProviderName", a.providerName));
    a.type !== undefined && b.push(oteljs.makeStringDataField(c + ".Type", a.type));
    return b;
  }
  b.getFields = a;
})(SDX || (SDX = {}));
    ...
    b = (function () {
      ...
      b.attachLegacyAgaveSink = function (e) {
        var d = function () {
          ...
          a = 5e3;
        OSF.OUtil.loadScript(b.getOtelSinkCDNLocation(), d, a, OSF.TrustedTypesPolicy);
      };
      ...
      OTel &&
        ...
        OTel.OTelLogger.onTelemetryLoaded(function () {
          Microsoft.Office.WebExtension.sendTelemetryEvent({
            eventName: "Office.Extensibility.OfficeJs.ApiCall",
            dataFields: [oteljs.makeStringDataField("Api", "Office.actions.associate")],
            eventFlags: { dataCategories: 2, diagnosticLevel: 110 },
          });
        });
      a._association.associate.apply(a._association, arguments);
    }
...
(function (a) {
  function b() {}
  a.addAllowedScriptUrl = b;
  function d() {
    return !!OSF.TrustedTypesPolicy;
  }
  a.isEnabled = d;
  function c() {
    ...
    var b = document.currentScript,
      c = b.src,
      a = new URL(c).origin.toLowerCase();
    if (!a) return;
    var d = window.trustedTypes.createPolicy("officejs", {
      createScriptURL: function (b) {
        var e = b.toLowerCase(),
          h = new URL(e).origin;
        if (a && a === h) return b;
        for (
          var f = ["https://alcdn.msauth.net/browser-1p/2.28.1/js/msal-browser-1p.min.js"],
            c = 0,
            d = f;
          c < d.length;
          c++
    ...
    OSF.TrustedTypesPolicy = d;
  }
  a.initialize = c;
})(OSFTrustedTypes || (OSFTrustedTypes = {}));
OSF.TrustedTypes = OSFTrustedTypes;
var g_isExpEnabled = g_isExpEnabled || false,
  g_isOfflineLibrary = g_isOfflineLibrary || false;
(function () {
  var a = OSF.ConstantNames || {};
  OSF.ConstantNames = {
    FileVersion: "16.0.19420.15030",
    OfficeJS: "office.js",
...
OSF._OfficeAppFactory = (function () {
  ...
  var z = { 0: "Unknown", 1: "Hidden", 2: "Taskpane", 3: "Dialog" };
  ...
  var r = {},
    ...
    v = e,
    u = function () {
      return Microsoft.Office.WebExtension.initialize != undefined || v;
    },
    k = { host: b, platform: b, addin: b };
  if (!window.__initializeNestedAppAuth)
    window.__initializeNestedAppAuth = function () {
      if (u())
        return Microsoft.Office.WebExtension.onReadyInternal().then(function () {
          return void 0;
        });
      console.warn(
        'Your add-in should call "Office.onReady()" or set "Office.initialize" before using Nested App Auth.'
      );
      return Office.Promise.resolve();
    };
  var h = new ScriptLoading.LoadScriptHelper({
    OfficeJS: OSF.ConstantNames.OfficeJS,
    OfficeDebugJS: OSF.ConstantNames.OfficeDebugJS,
  });
  try {
    if (h.getTrustedTypesOptIn()) {
      self.osfLoadMsAjax = e;
      OSFTrustedTypes.initialize();
    }
  } catch (J) {}
  window.performance &&
    window.performance.now &&
    h.logScriptLoading(OSF.ConstantNames.OfficeJsId, -1, window.performance.now());
  ...
  var p = function (g) {
    ...
    F = function () {
      ...
      if (h) {
        ...
        if (c.osfControlAppCorrelationId == "telemetry") c.osfControlAppCorrelationId = f;
        c.isDialog = typeof g[5] != a && g[5] == l ? d : e;
        c.disableLogging = typeof g[6] != a && g[6] == "disableLogging" ? d : e;
        c.flags = typeof g[7] === "string" && g[7].length > 0 ? parseInt(g[7]) : 0;
        if (g_isOfflineLibrary) g_isExpEnabled = e;
        else g_isExpEnabled = g_isExpEnabled || !!(c.flags & OSF.HostInfoFlags.ExperimentJsEnabled);
    ...
    H = function () {
      F();
      B();
      if (c.hostPlatform == "web" && c.isDialog && window == window.top && window.opener == b) {
        window.open(f, "_self", f);
        window.close();
      }
      if ((c.flags & (OSF.HostInfoFlags.SharedApp | OSF.HostInfoFlags.CustomFunction)) !== 0)
      ...
      var n = function () {
            ...
            c = function () {
              if (typeof Strings == a || typeof Strings.OfficeOM == a)
                if (!b) {
                  b = d;
                  var g =
                    k + OSF.ConstantNames.DefaultLocale + "/" + OSF.ConstantNames.OfficeStringJS;
                  h.loadScript(
                    g,
        ...
        s = function (s) {
          if (s) {
            i = new OSF.InitializationHelper(c, j, r, I, q);
            c.hostPlatform == "web" && i.saveAndSetDialogInfo && i.saveAndSetDialogInfo(p(m));
            ...
            E(j.wnd, function (d) {
                    ...
                    if (f) {
                      if (i.prepareApiSurface)
                        Microsoft.Office.WebExtension.initialize &&
                          Microsoft.Office.WebExtension.initialize(i.getInitializationReason(d));
                      else {
                      ...
                      i.prepareRightAfterWebExtensionInitialize &&
                        i.prepareRightAfterWebExtensionInitialize(d);
                      var e = d.get_appName(),
                        a = b;
                      if ((c.flags & OSF.HostInfoFlags.SharedApp) !== 0)
                        a = {
                          visibilityMode:
                            z[
                              d.get_initialDisplayMode && typeof d.get_initialDisplayMode === g
              ...
              !h.isScriptLoading(OSF.ConstantNames.OfficeStringsId) && w(d.get_appUILocale());
            ...
            if (c.isO15) {
              var n = OSF.OUtil.parseXdmInfo() == b;
              if (n) {
                var f = d;
        ...
        y = function () {
          OSF.AppTelemetry &&
            ...
            OSF.AppTelemetry.setOsfControlAppCorrelationId(c.osfControlAppCorrelationId);
          if (h.isScriptLoading(OSF.ConstantNames.MicrosoftAjaxId))
            h.waitForScripts([OSF.ConstantNames.MicrosoftAjaxId], s);
          else h.waitForFunction(n, s, 500, 100);
        };
      if (c.isO15)
        h.loadScript(k + OSF.ConstantNames.O15InitHelper, OSF.ConstantNames.O15MappingId, y);
      else {
        var v = c.hostType.toLowerCase(),
          A = c.hostPlatform.toLowerCase(),
          H = new RegExp("^\\d\\d[.]\\d\\d$");
        if (
          OSF.HostSpecificFileVersionMap[v] == b ||
          OSF.HostSpecificFileVersionMap[v][A] == b ||
          !H.test(c.hostSpecificFileVersion)
        )
      ...
      var C = c.hostType == "outlook" && c.hostPlatform == "android";
      if (!C) {
  ...
  return {
    ...
    getCachedSessionSettingsKey: function () {
      return (j.conversationID != b ? j.conversationID : x) + "CachedSessionSettings";
    },
...
!(function () {
  ...
  function v(e, t, n, r) {
    return { name: e, dataType: t, value: n, classification: r || 4 };
  }
  (s.r(c),
    s.d(c, {
      Activity: function () {
      ...
      CostPriority: function () {
        return W;
      },
      CustomerContentType: function () {
        return $;
      },
      DataCategories: function () {
        return B;
      },
      DataClassification: function () {
        return G;
      },
      DataFieldType: function () {
        return H;
      },
      DiagnosticLevel: function () {
        return q;
      },
      DnmInterval: function () {
        return K;
      },
      ...
      HealthQosError: function () {
        return V;
      },
      LogLevel: function () {
        return Z;
      },
      PersistencePriority: function () {
        return Q;
      },
      Platform: function () {
        return O;
      },
      PrimaryIdentitySpace: function () {
        return D;
      },
      QosPillarName: function () {
        return U;
      },
      Release: function () {
        return te;
      ...
      SamplingPolicy: function () {
        return L;
      },
      Session: function () {
        return _;
      },
      SimpleTelemetryLogger: function () {
        return Pe;
      },
      SuppressNexus: function () {
        return Te;
      },
      TelemetryLogger: function () {
        return be;
      },
      ...
      getEffectiveEventFlags: function () {
        return ce;
      },
      logError: function () {
        return se;
      },
      logNotification: function () {
        return ae;
      },
      makeBooleanDataField: function () {
        return u;
      },
      makeDoubleDataField: function () {
        return d;
      },
      makeGuidDataField: function () {
        return f;
      },
      makeInt64DataField: function () {
        return l;
      },
      makeStringDataField: function () {
        return p;
      },
      onNotification: function () {
        return oe;
      },
      parseTraceContext: function () {
        return $e;
      },
      sendHealthQosError: function () {
        return Oe;
      },
    }),
    (function (e) {
      e.getFields = function (e, t) {
        var n = [];
        return (
          n.push(l("".concat(e, ".Code"), t.code)),
          void 0 !== t.type && n.push(p("".concat(e, ".Type"), t.type)),
          void 0 !== t.tag && n.push(l("".concat(e, ".Tag"), t.tag)),
          void 0 !== t.isExpected && n.push(u("".concat(e, ".IsExpected"), t.isExpected)),
          n.push(p("zC.Activity.Result", "Office.System.Result")),
          n
        );
      };
    })(e || (e = {})),
    (function (t) {
      ((t.contractName = "Office.System.Activity"),
        (t.getFields = function (n) {
          var r = "Activity",
            i = [];
          return (
            void 0 !== n.cV && i.push(p("".concat(r, ".CV"), n.cV)),
            i.push(l("".concat(r, ".Duration"), n.duration)),
            i.push(l("".concat(r, ".Count"), n.count)),
            i.push(l("".concat(r, ".AggMode"), n.aggMode)),
            void 0 !== n.success && i.push(u("".concat(r, ".Success"), n.success)),
            void 0 !== n.result && i.push.apply(i, e.getFields("".concat(r, ".Result"), n.result)),
            i.push(p("zC.Activity", t.contractName)),
            i
          );
        }));
    })(t || (t = {})),
    (function (e) {
      e.getFields = function (e, t) {
        var n = [];
        return (
          void 0 !== t.id && n.push(p("".concat(e, ".Id"), t.id)),
          void 0 !== t.version && n.push(p("".concat(e, ".Version"), t.version)),
          void 0 !== t.sessionId && n.push(p("".concat(e, ".SessionId"), t.sessionId)),
          n
        );
      };
    })(n || (n = {})),
    (function (e) {
      e.getFields = function (e, t) {
        var n = [];
        return (
          void 0 !== t.alias && n.push(p("".concat(e, ".Alias"), t.alias)),
          void 0 !== t.primaryIdentityHash &&
            n.push(p("".concat(e, ".PrimaryIdentityHash"), t.primaryIdentityHash)),
          void 0 !== t.primaryIdentitySpace &&
            n.push(p("".concat(e, ".PrimaryIdentitySpace"), t.primaryIdentitySpace)),
          void 0 !== t.tenantId && n.push(p("".concat(e, ".TenantId"), t.tenantId)),
          void 0 !== t.tenantGroup && n.push(p("".concat(e, ".TenantGroup"), t.tenantGroup)),
          void 0 !== t.isAnonymous && n.push(u("".concat(e, ".IsAnonymous"), t.isAnonymous)),
          n
        );
      };
    })(r || (r = {})),
    (function (e) {
      e.getFields = function (e, t) {
        var n = [];
        return (
          void 0 !== t.name && n.push(p("".concat(e, ".Name"), t.name)),
          void 0 !== t.state && n.push(p("".concat(e, ".State"), t.state)),
          n
        );
      };
    })(i || (i = {})),
    (function (e) {
      e.getFields = function (e, t) {
        var n = [];
        return (
          void 0 !== t.id && n.push(l("".concat(e, ".Id"), t.id)),
          void 0 !== t.name && n.push(p("".concat(e, ".Name"), t.name)),
          void 0 !== t.commandSurface &&
            n.push(p("".concat(e, ".CommandSurface"), t.commandSurface)),
          void 0 !== t.parentName && n.push(p("".concat(e, ".ParentName"), t.parentName)),
          void 0 !== t.triggerMethod && n.push(p("".concat(e, ".TriggerMethod"), t.triggerMethod)),
          void 0 !== t.timeOffsetMs && n.push(l("".concat(e, ".TimeOffsetMs"), t.timeOffsetMs)),
          n
        );
      };
    })(o || (o = {})),
    (function (e) {
      e.getFields = function (e, t) {
        var n = [];
        return (
          n.push(p("".concat(e, ".ErrorGroup"), t.errorGroup)),
          n.push(l("".concat(e, ".Tag"), t.tag)),
          void 0 !== t.code && n.push(l("".concat(e, ".Code"), t.code)),
          void 0 !== t.id && n.push(l("".concat(e, ".Id"), t.id)),
          void 0 !== t.count && n.push(l("".concat(e, ".Count"), t.count)),
          n
        );
      };
    })(a || (a = {})));
  ...
  function P(e, t, n, r, i) {
    (void 0 === i && (i = 4), r && e.push(p("".concat(E(t, n)), r, i)));
  }
  function A(e, t, n, r) {
    "boolean" == typeof r && e.push(u("".concat(E(t, n)), r));
  }
  function F(e, t, n, r) {
    "number" == typeof r && e.push(l("".concat(E(t, n)), r));
  }
  !(function (e) {
    var t, n;
    ((t = e.Office || (e.Office = {})),
      ((n = t.System || (t.System = {})).Activity = y),
      (n.Result = g),
      (n.Error = h),
      (n.Funnel = I),
      (n.Host = S),
  ...
  var D,
    ...
    b = {
      ...
      getFields: function (e) {
        ...
        return (
          P(n, t, "CV", e.cV),
          F(n, t, "Duration", e.duration),
          F(n, t, "Count", e.count),
          F(n, t, "AggMode", e.aggMode),
          A(n, t, "Success", e.success),
          e.result && n.push.apply(n, N.getFields(e.result)),
          n.push(p("zC.Activity", this.contractName)),
          n
        );
      },
    };
  !(function (e) {
    ((e.UserObjectId = "UserObjectId"),
      (e.MSACID = "MSACID"),
      (e.MsaPuid = "MsaPuid"),
      (e.MSAPUID = "MSAPUID"),
      (e.OrgIdPuid = "OrgIdPuid"),
      (e.OrgIdPUID = "OrgIdPUID"),
      (e.OrgIdCID = "OrgIdCID"),
      (e.WopiAuth = "WopiAuth"),
  ...
  var O,
    M = {
      getFields: function (e) {
        var t = "User",
          n = [];
        return (
          P(n, t, "PrimaryIdentityHash", e.primaryIdentityHash),
          P(n, t, "PrimaryIdentitySpace", e.primaryIdentitySpace),
          P(n, t, "TenantId", e.tenantId, 1),
          P(n, t, "TenantGroup", e.tenantGroup, 1),
          A(n, t, "IsAnonymous", e.isAnonymous),
          A(n, t, "IsSignedIn", e.isSignedIn),
          n
        );
      },
    },
    k = {
      getFields: function (e, t) {
        var n = [];
        return (P(n, e, "Name", t.name), P(n, e, "State", t.state), n);
      },
    },
    w = {
      getFields: function (e) {
        ...
        return (
          F(n, t, "Id", e.id),
          P(n, t, "Name", e.name),
          P(n, t, "CommandSurface", e.commandSurface),
          P(n, t, "ParentName", e.parentName),
          P(n, t, "TriggerMethod", e.triggerMethod),
          F(n, t, "TimeOffsetMs", e.timeOffsetMs),
          n
        );
      },
    };
  ...
  var U,
    R = {
      getFields: function (e) {
        ...
        return (
          P(n, t, "Name", e.name, 1),
          P(n, t, "Platform", e.platform, 1),
          P(n, t, "Version", e.version, 1),
          n
        );
      },
    },
    _ = {
      getFields: function (e) {
        var t = "Session",
          n = [];
        return (P(n, t, "Id", e.id, 1), P(n, t, "EcsETag", e.ecsETag, 1), n);
      },
    };
  !(function (e) {
    ((e.Interruptions = "Interruptions"),
      (e.Open = "Open"),
      (e.Save = "Save"),
      (e.RealTimeCoauth = "RealTimeCoauth"),
      (e.NotebookNavigation = "NotebookNavigation"),
      (e.Fidelity = "Fidelity"),
      (e.AsyncCollab = "AsyncCollab"),
      (e.Present = "Present"),
      (e.ContentConsumption = "ContentConsumption"),
      (e.ContentCreation = "ContentCreation"));
  })(U || (U = {}));
  var j,
    V = {
      getFields: function (e) {
        var t = [];
        return (
          t.push(p("Pillar", e.pillar)),
          t.push(p("Veto", e.veto)),
          t.push(u("IsIntentional", e.isIntentional)),
          t.push(u("IsInternal", e.isInternal)),
          t.push(u("AlertOnPillar", e.alertOnPillar)),
          t.push(u("IsSessionEndingError", e.isSessionEndingError)),
  ...
  var x,
    ...
    te = {
      getFields: function (e) {
        var t = [];
        return (P(t, "Release", "AudienceGroup", e.audienceGroup, 1), t);
      },
    };
  (!(function (e) {
    var t,
      ...
      i,
      o = "Copilot";
    (((i = e.FeatureActionType || (e.FeatureActionType = {})).IsEnabled = "IsEnabled"),
      (i.IsSeen = "IsSeen"),
      (i.IsTried = "IsTried"),
      (i.IsKept = "IsKept"),
      (i.IsRejected = "IsRejected"),
      ((r = e.Capability || (e.Capability = {})).ContentGeneration = "Content Generation"),
      (r.Commanding = "Commanding"),
      (r.QAandSummaries = "QA and Summaries"),
      (r.Collaboration = "Collaboration"),
      (r.Suggestions = "Suggestions"),
      ((n = e.EntryPoint || (e.EntryPoint = {})).Chat = "Chat"),
      (n.Canvas = "Canvas"),
      ((t = e.Verb || (e.Verb = {})).Create = "Create"),
      (t.Command = "Command"),
      (t.Ask = "Ask"),
      ...
      (e.getFields = function (e) {
        var t = [];
        return (
          P(t, o, "FeatureActionType", e.featureActionType),
          A(t, o, "IsUserInitiated", e.isUserInitiated),
          P(t, o, "FeatureName", e.featureName),
          P(t, o, "SubFeatureName", e.subFeatureName),
          P(t, o, "Capability", e.capability),
          A(t, o, "IsThumbsUp", e.isThumbsUp),
          P(t, o, "EntryPoint", e.entryPoint),
          P(t, o, "Verb", e.verb),
          t.push(p("zC.".concat(o), "Office.System.Copilot")),
          t
        );
      }));
  })(x || (x = {})),
    (function (e) {
      var t = "Asha";
      (!(function (e) {
        ((e.Pillar = "Pillar"), (e.Error = "Error"));
      })(e.EventType || (e.EventType = {})),
        (e.getFields = function (e) {
          var n = [];
          return (
            P(n, t, "EventType", e.eventType),
            P(n, t, "Pillar", e.pillar),
            P(n, t, "Scenario", e.scenario),
            P(n, t, "Veto", e.veto),
            P(n, t, "Error", e.error),
            A(n, t, "InStaging", e.inStaging),
            A(n, t, "IsSessionEndingError", e.isSessionEndingError),
            A(n, t, "IsIntentional", e.isIntentional),
            A(n, t, "IsInternal", e.isInternal),
            n.push(p("zC.".concat(t), "Office.System.Asha")),
            n
          );
        }));
    })(z || (z = {})),
    (function (e) {
      ((e[(e.EssentialServiceMetadata = 1)] = "EssentialServiceMetadata"),
        ...
        (e[(e.OrganizationIdentifiableInformation = 8)] = "OrganizationIdentifiableInformation"),
        (e[(e.EndUserIdentifiableInformation = 16)] = "EndUserIdentifiableInformation"),
        (e[(e.CustomerContent = 32)] = "CustomerContent"),
        (e[(e.AccessControl = 64)] = "AccessControl"),
        (e[(e.PublicNonPersonalData = 128)] = "PublicNonPersonalData"),
        (e[(e.EndUserPseudonymousInformation = 256)] = "EndUserPseudonymousInformation"),
        (e[(e.PublicPersonalData = 512)] = "PublicPersonalData"),
        (e[(e.SupportData = 1024)] = "SupportData"),
        (e[(e.DirectMeasurementData = 2048)] = "DirectMeasurementData"),
        (e[(e.Everything = 65535)] = "Everything"));
    })(G || (G = {})),
    (function (e) {
      ((e[(e.String = 0)] = "String"),
    ...
    (function (e) {
      ((e[(e.ReservedDoNotUse = 0)] = "ReservedDoNotUse"),
        (e[(e.Required = 10)] = "Required"),
        (e[(e.BasicEvent = 10)] = "BasicEvent"),
        (e[(e.Optional = 100)] = "Optional"),
        (e[(e.FullEvent = 100)] = "FullEvent"),
        (e[(e.RequiredServiceData = 110)] = "RequiredServiceData"),
        (e[(e.NecessaryServiceDataEvent = 110)] = "NecessaryServiceDataEvent"),
        (e[(e.RequiredServiceDataForEssentialServices = 120)] =
          "RequiredServiceDataForEssentialServices"),
        (e[(e.AlwaysOnNecessaryServiceDataEvent = 120)] = "AlwaysOnNecessaryServiceDataEvent"));
    })(q || (q = {})),
    (function (e) {
      ((e[(e.None = 0)] = "None"), (e[(e.MocaAddIn = 1)] = "MocaAddIn"));
    })($ || ($ = {})),
    (function (e) {
      ((e[(e.Error = 0)] = "Error"),
    ...
    (function (e) {
      ((e[(e.Hourly = 1)] = "Hourly"), (e[(e.Daily = 2)] = "Daily"));
    })(K || (K = {})),
    (function (e) {
      ((e[(e.ReleaseAudienceGroup = 1)] = "ReleaseAudienceGroup"),
        (e[(e.WacRing = 2)] = "WacRing"),
        (e[(e.AppName = 3)] = "AppName"),
        (e[(e.AppPlatform = 4)] = "AppPlatform"),
        (e[(e.AppVersion = 5)] = "AppVersion"));
    })(X || (X = {})),
    (function (e) {
      ((e[(e.SendTelemetryEvent = 1)] = "SendTelemetryEvent"),
        (e[(e.CustomerContent = 2)] = "CustomerContent"),
        (e[(e.DirectNumericEvent = 3)] = "DirectNumericEvent"));
    })(Y || (Y = {})));
  var ne,
    re = (function () {
      function e(e) {
  ...
  function ae(e, t, n) {
    ie.fireEvent({ level: e, category: t, message: n });
  }
  function se(e, t, n) {
    ae(0, e, function () {
  ...
  function fe(e, t) {
    "Office." === e.substring(0, 7) && "." !== e[e.length - 1]
      ? pe[e]
        ? (t.ariaTenantToken && (pe[e].ariaTenantToken = t.ariaTenantToken),
          t.dnmToken && (pe[e].dnmToken = t.dnmToken))
        : (pe[e] = t)
      : ae(0, 0, function () {
  ...
  function ve(e, t) {
    for (var n = e.length; n > 0; ) {
      ...
      if (pe[r]) {
        var i = pe[r];
        return ((t.ariaTenantToken = i.ariaTenantToken), (t.dnmToken = i.dnmToken), !0);
      }
      n = e.lastIndexOf(".", n - 1);
    }
    return !1;
  ...
  function Ce(e) {
    e &&
      e.forEach(function (e) {
        if ("string" != typeof e.name || !Se(e.name)) throw new Error("Invalid dataField name");
        2 === e.dataType &&
          (function (e) {
            if ("number" != typeof e || !isFinite(e) || Math.floor(e) !== e || e < ge || e > ye)
              throw new Error("Invalid integer ".concat(JSON.stringify(e)));
          })(e.value);
      });
  }
  !(function (e) {
    ((e[(e.TelemetryData = 0)] = "TelemetryData"),
      (e[(e.AnonymousData = 1)] = "AnonymousData"),
      (e[(e.CustomerContent = 2)] = "CustomerContent"));
  })(me || (me = {}));
  var Te = -1;
  function Ee(e) {
    var t = {
      ...
      telemetryProperties: e.telemetryProperties ? le({}, e.telemetryProperties) : {},
      ...
      function e(e, t, n) {
        ...
        ((this.telemetrySinks = []),
          ...
          e &&
            ...
            (this.config = le(le({}, e.getConfig()), this.config)),
            (i = this.partAFields).push.apply(i, e.partAFields)),
          t && (o = this.persistentDataFields).push.apply(o, t));
      }
      return (
        (e.prototype.addEventContentType = function (e, t) {
          e.push(l("EventContent.Type", t));
        }),
        (e.prototype.sendTelemetryEvent = function (e) {
          var t = Ee(e),
            n = t.telemetryProperties;
          n.nexusTenantToken = Te;
          var r = n.ariaTenantToken;
          r || ve(t.eventName, n) || r
            ? this.sendTelemetryEventInternal(t, 1)
            : ae(0, 0, function () {
                return "No tenant token: " + e.eventName;
              });
        }),
        (e.prototype.sendNonStandardEvent = function (e, t) {
          var n = Ee(e);
          this.sendTelemetryEventInternal(n, t);
        }),
        (e.prototype.sendCustomerContent = function (e) {
          var t = Ee(e),
            n = t.telemetryProperties,
            r = n.customerContentVersion;
          return (
            (!r || r > 2) && (n.customerContentVersion = 2),
        ...
        (e.prototype.sendDirectNumericEvent = function (e) {
          var t = Ee(e),
            n = t.telemetryProperties;
          n.dnmToken || ve(t.eventName, n) || n.dnmToken
        ...
        (e.prototype.sendTelemetryEventInternal = function (e, t) {
          if (
            2 === t ||
            (!e.telemetryProperties.customerContentVersion &&
              !e.telemetryProperties.customerContentType)
          ) {
            try {
              ...
              return void se(0, "SendTelemetryEvent", e);
            }
            this.telemetrySinks.forEach(function (n) {
              try {
                3 === t || 2 === t
                  ? n.sendNonStandardEvent && n.sendNonStandardEvent(e, t)
                  : n.sendTelemetryEvent(e);
              } catch (e) {}
            });
          } else
            ae(0, 0, function () {
        ...
        (e.prototype.processTelemetryEvent = function (e, t) {
          ...
          if (
            (e.dataFields &&
              (null === (i = e.dataFields) ||
                void 0 === i ||
                i.unshift(p("OTelJS.Version", "4.18.2")),
              3 !== t &&
                this.persistentDataFields &&
                (n = e.dataFields).unshift.apply(n, this.persistentDataFields)),
            this.partAFields.length > 0)
          ) {
            var o = e.eventContract || { name: "", dataFields: [] };
            ((r = o.dataFields).push.apply(r, this.partAFields), (e.eventContract = o));
          }
          this.config.disableValidation ||
            (function (e) {
              if (!(t = e.eventName) || t.length > 98 || !he.test(t))
                throw new Error("Invalid eventName");
              var t,
                n = e.eventContract;
              if (n) {
                if (n.name && !Se(n.name)) throw new Error("Invalid eventContract");
                Ce(n.dataFields);
              }
              Ce(e.dataFields);
            })(e);
          ...
          if (((this.eventQueue = []), this.telemetrySinks.length > 0))
            for (var t = 0, n = e; t < n.length; t++) {
              var r = n[t],
                i = r[0],
                o = r[1];
              this.sendTelemetryEventInternal(i, o);
            }
        }),
        (e.prototype.setTenantToken = function (e, t, n) {
          fe(e, { ariaTenantToken: t, nexusTenantToken: n });
        }),
  ...
  var Fe,
    ...
    Ne = function (e) {
      var t,
        n = Ae(),
        r = Ee(e.telemetryEvent);
      return le(le({ cv: e.parentCv.getNext() }, r), {
        createChildActivity: function (t) {
          return Ne({
            telemetryEvent: t,
            sendTelemetryEvent: e.sendTelemetryEvent,
            parentCv: this.cv,
          });
        },
        ...
        endNow: function () {
          ...
          if (!t) {
            ...
            var a = {
              ...
              s =
                null !==
                  (i = null === (r = this.eventContract) || void 0 === r ? void 0 : r.dataFields) &&
                void 0 !== i
                  ? i
                  : [];
            return (
              s.push.apply(s, b.getFields(a)),
              (this.eventContract = { name: b.contractName, dataFields: s }),
    ...
    be = (function (e) {
      ...
      return (
        ...
        (t.prototype.sendActivity = function (e, t, n, r) {
          return this.sendTelemetryEvent({
            eventName: e,
            eventContract: { name: b.contractName, dataFields: b.getFields(t) },
            dataFields: n,
            eventFlags: r,
          });
        }),
        (t.prototype.sendError = function (e) {
          var t = (function (e) {
            var t = "Error",
              n = [];
            return (
              n.push(p("".concat(t, ".ErrorGroup"), e.errorGroup)),
              n.push(l("".concat(t, ".Tag"), e.tag)),
              void 0 !== e.code && n.push(l("".concat(t, ".Code"), e.code)),
              void 0 !== e.id && n.push(l("".concat(t, ".Id"), e.id)),
              void 0 !== e.count && n.push(l("".concat(t, ".Count"), e.count)),
              n
            );
          })(e.error);
          return (
  ...
  function Oe(e, t, n, r, i, o, a, s, c, u, l) {
    r.forEach(function (r) {
      e.sendTelemetryEvent({
        ...
        telemetryProperties: { ariaTenantToken: t.token, nexusTenantToken: Te },
      });
    });
  }
  (!(function (e) {
  ...
  var Me = "[-_*/0-9a-z]",
    ke = "[a-z]".concat(Me, "{0,255}"),
    we = "[0-9a-z]".concat(Me, "{0,240}"),
    Ue = "[a-z]".concat(Me, "{0,13}"),
    Re = "".concat(we, "@").concat(Ue),
    _e = new RegExp("^(?:".concat(ke, "|").concat(Re, ")$")),
    je = /^[ -+--<>-~]{0,255}[!-+--<>-~]$/,
    Ve = (function () {
      function e() {
        this._listMemberMap = new Map();
      }
      return (
        (e.prototype.set = function (e, t) {
          if (!_e.test(e) || !je.test(t)) return !1;
          var n = this._listMemberMap;
          return (
            n.has(e) && n.delete(e),
            n.set(e, t),
            n.size > 32 && n.delete(n.keys().next().value),
            !0
          );
        }),
        (e.prototype.unset = function (e) {
          this._listMemberMap.delete(e);
        }),
        (e.prototype.get = function (e) {
          return this._listMemberMap.get(e);
        }),
        Object.defineProperty(e.prototype, "keys", {
          get: function () {
            return Array.from(this._listMemberMap.keys()).reverse();
          },
          enumerable: !1,
          configurable: !0,
        }),
        (e.prototype.serialize = function () {
          ...
          return this.keys
            .map(function (t) {
              return "".concat(t).concat("=").concat(e._listMemberMap.get(t));
            })
            .join(",");
        }),
        (e.parse = function (t) {
          ...
          return (
            r.reverse().forEach(function (e) {
              ...
              if (t) {
                var r = t.split("=");
                (2 === r.length && n.set(r[0], r[1])) ||
                  (ae(1, 0, function () {
                    return "Invalid trace state entry '".concat(t, "'");
                  }),
                  (i = !1));
              }
            }),
    ...
    xe = /^([\da-f]{2})-([\da-f]{32})-([\da-f]{16})-([\da-f]{2})(-\S+)?$/,
    ze = function (e) {
      return /^0+$/.test(e);
    },
    Ge = /^([\da-f]{16})$/,
    ...
    Le = (function () {
      function e(e, t, n) {
        (void 0 === e && (e = We()),
          ...
          (this.version = "00"),
          (this._parentId = t),
          (this._traceFlags = (function (e) {
            return (void 0 === e && (e = De.None), e & De.Sampled);
          })(n)));
      }
      return (
        Object.defineProperty(e.prototype, "parentId", {
          get: function () {
        ...
        Object.defineProperty(e.prototype, "traceFlags", {
          get: function () {
        ...
        (e.prototype.isValid = function () {
          return xe.test(this.serialize()) && !ze(this.traceId) && !ze(this._parentId);
        }),
        (e.prototype.isSampled = function () {
          return (this.traceFlags & De.Sampled) === De.Sampled;
        }),
        (e.prototype.updateSampled = function (e, t) {
          return (
            t !== this._parentId &&
            !!this.updateParentId(t) &&
            ((this._traceFlags = e
              ? this._traceFlags | De.Sampled
              : this._traceFlags & ~De.Sampled),
            !0)
          );
        }),
        (e.prototype.updateParentId = function (e) {
          return e
            ? !(!Ge.test(e) || ze(e) || ((this._parentId = e), 0))
            : ((this._parentId = Be()), !0);
        }),
        (e.prototype.serialize = function () {
          return ""
            .concat(this.version, "-")
            .concat(this.traceId, "-")
            .concat(this._parentId, "-0")
            .concat(this._traceFlags);
        }),
        ...
        (e.createNew = function (t) {
          return new e(We(), Be(), t);
        }),
        (e.parse = function (t) {
          var n = xe.exec(t);
          if (n && "ff" !== n[1] && ("00" !== n[1] || !n[5]))
            return e.create(n[2], n[3], parseInt(n[4], He));
        }),
        e
      );
    })();
  function Qe(e) {
    ...
    var n = Array.from(t)
      .map(function (e) {
        return (256 + e).toString(He).slice(1);
      })
      .join("");
    return ze(n) ? n.slice(1) + "1" : n;
  }
  function We() {
    return Qe(16);
  }
    ...
    return (
      (e.getFields = function (e) {
        var t = "Event.",
          n = e.parent,
          r = e.state,
          i = r ? r.serialize() : void 0;
        return de(
          [
            p(t + "TraceId", n.traceId),
            p(t + "TraceParentId", n.parentId),
            l(t + "TraceFlags", n.traceFlags),
          ],
          i ? [p(t + "TraceState", i)] : [],
          !0
        );
  ...
  function $e(e, t) {
    ...
    return (
      r && t && (n = Ve.parse(t)),
      (n = n || new Ve()),
      { parent: r || Le.createNew(), state: n }
    );
  }
  function Ze(e) {
    return { parent: Le.createNew(e), state: new Ve() };
  }
  oteljs = c;
})();
