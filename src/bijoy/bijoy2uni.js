...
function ConvertToUnicode(ConvertFrom, line) {
    ...
    var asciiKeys = Object.keys(conversion_map).sort(function(a, b) { return b.length - a.length; });
    for (var k = 0; k < asciiKeys.length; k++) {
        var ascii = asciiKeys[k];
    ...
    line = line.replace(/(^|[^0-9A-Za-z\u0980-\u09FF])ঃ/g, "$1:");
    // Normalize duplicate long u-kar: collapse consecutive 'ূ' into a single one
    line = line.replace(/ূূ+/g, "ূ");
    return line;
}
